import sys
sys.path.append('heritage-housing-mvp')
...
def load_heritage_data():
    ...
    """
    df2 = pd.read_csv("outputs/datasets/collection/inherited_houses.csv")
    return df2
...
def load_housing_cleaned():
    ...
    """
    df3 = pd.read_csv("outputs/datasets/collection/HousePricesCleaned.csv")
    return df3
